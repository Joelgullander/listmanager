...
<input type="text" name="usernameReg" placeholder="Username" required="required" />
<input type="password" name="passwordReg" placeholder="Password" required="required" />
<input type="submit" name="signupSubmit" class="btn btn-primary btn-block btn-large" value="Logga in"/>
</form>
</div>
